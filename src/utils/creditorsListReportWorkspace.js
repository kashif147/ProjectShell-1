const RELOAD_EVENT = "creditors-list-report-reload";
...
export function buildCreditorsListRequest(
  filtersState = {},
...
export function formatCreditorsReportPeriodLabel(filtersState = {}, meta = {}) {
...
export function bumpCreditorsListReportReload() {
  window.dispatchEvent(new CustomEvent(RELOAD_EVENT));
}

export function subscribeCreditorsListReportReload(handler) {
