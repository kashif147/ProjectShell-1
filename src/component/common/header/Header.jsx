          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              ...
              >
                <li
                  className={`${
                    pathname === "/Summary" || pathname === "/Details"
                      ? "activ-link"
                      : ""
                  } nav-item nav-links-container`}
                >
                  <MyDrowpDown title={"Profile"} items={navLinks} />
                </li>
                <li
                  className={`${
                    pathname === "/CasesSummary" || pathname === "/CasesDetails"
                      ? "activ-link"
                      : ""
                  } nav-item nav-links-container`}
                >
                ...
                <li
                  className={`${
                    pathname === "/ClaimSummary" || pathname === "/Claims"
                      ? "activ-link"
                      : ""
                  } nav-item nav-links-container`}
                >
                ...
                <li
                  className={`${
                    pathname === "/CorrespondencesSummary" ? "activ-link" : ""
                  } nav-item nav-links-container`}
                >
                  <MyDrowpDown
                    title={"Correspondences"}
                    items={CorrespondencesLink}
                  />
                </li>
                <li
                  className={`${
                    pathname === "/RosterSummary" ? "activ-link" : ""
                  } nav-item nav-links-container`}
                >
                ...
                <li
                  className={`${
                    pathname === "/Transfers" ? "activ-link" : ""
                  } nav-item nav-links-container`}
                >
                  <Link
                    className="links"
                    to="Transfers"
                    state={{ search: "Transfers" }}
                  >
                    Transfer Requests
                  </Link>
                </li>
                <li
                  className={`${
                    pathname === "/Report2" || pathname === "/Report1"
                      ? "activ-link"
                      : ""
                  } nav-item nav-links-container`}
                >
                ...
                <li
                  className={`${
                    pathname === "/Configuratin" ? "activ-link" : ""
                  } nav-item nav-links-container`}
                >
                  <Link
                    className="links"
