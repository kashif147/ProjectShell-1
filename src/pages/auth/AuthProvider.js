...
//         redirectUri: 'http://localhost:3000' //process.env.REACT_APP_REDIRECT_URI, // Your redirect URI
//     },
//     cache: {
...
//       authority: `https://login.microsoftonline.com/${process.env.REACT_APP_TENANT_ID}`, // Correct tenant ID
//       redirectUri: process.env.REACT_APP_REDIRECT_URI, // Your redirect URI
//     },
//     cache: {
//       cacheLocation: 'sessionStorage', // Recommended for storing tokens
//       storeAuthStateInCookie: false,  // Useful for avoiding Safari issues
//     },
//   };
