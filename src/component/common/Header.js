...
function Header() {
  ...
  <a class="navbar-brand" href="#" style={{color:"black", fontSize:"16px", fontWeight:"600"}}>Logo</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <li class="nav-item nav-links-container">
      ...
      {/* <MyDrowpDown title={"Projects"}  /> */}
      </li>
      <li class="nav-item nav-links-container">
        <MyDrowpDown title={"Claims"}  items={navLinks}  />
      {/* <MyDrowpDown title={"Filters"} /> */}
      </li>
      <li class="nav-item nav-links-container">
...
<div className='input-container d-flex'>
  ...
  <HiMiniQuestionMarkCircle style={{ fontSize: '27px', marginRight:"1rem" }}/>
