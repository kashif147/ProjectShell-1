...
export const TableColumnsProvider = ({ children }) => {
  ...
  const [searchFilters, setsearchFilters] = useState([{ titleColumn: "Reg No", isSearch: false },
    ...
    { titleColumn: "Surname", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,}, },
    { titleColumn: "Full Name", isSearch: true ,lookups:{ Male: false,
      Female: false,
      Other: false,}}, // Important (4)
    { titleColumn: "Date Of Birth", isSearch: true ,lookups:{ Male: false,
      Female: false,
    ...
    { titleColumn: "Date Of Death", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,} },
    { titleColumn: "Rank", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,} },
    { titleColumn: "Duty", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,} },
    { titleColumn: "Station", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,} },
    ...
    { titleColumn: "Associate Member", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,} },
    { titleColumn: "District", isSearch: false,lookups:{ Male: false,
      Female: false,
      Other: false,} },
