...
export const membershipDashboardAPI = {
  ...
  getDashboardStats: async () => {
    try {
      ...
      const response = await fetch("/api/membership/dashboard/stats");
  ...
  getMembershipByCategory: async () => {
    try {
      const response = await fetch("/api/membership/dashboard/by-category");
      return await response.json();
    } catch (error) {
      console.error("Error fetching membership by category:", error);
      return [
  ...
  getMembershipByGrade: async () => {
    try {
      const response = await fetch("/api/membership/dashboard/by-grade");
      return await response.json();
    } catch (error) {
      console.error("Error fetching membership by grade:", error);
      return [
  ...
  getMembershipBySection: async () => {
    try {
      const response = await fetch("/api/membership/dashboard/by-section");
      return await response.json();
    } catch (error) {
      console.error("Error fetching membership by section:", error);
      return [
  ...
  getMembershipByBranch: async () => {
    try {
      const response = await fetch("/api/membership/dashboard/by-branch");
      return await response.json();
    } catch (error) {
      console.error("Error fetching membership by branch:", error);
      return [
  ...
  getMembershipByRegion: async () => {
    try {
      const response = await fetch("/api/membership/dashboard/by-region");
      return await response.json();
    } catch (error) {
      console.error("Error fetching membership by region:", error);
      return [
  ...
  getMembershipByWorkLocation: async () => {
    try {
      const response = await fetch(
        "/api/membership/dashboard/by-work-location"
      );
      return await response.json();
    } catch (error) {
      console.error("Error fetching membership by work location:", error);
      return [
