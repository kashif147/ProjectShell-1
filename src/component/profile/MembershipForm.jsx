            ...
            <Row gutter={32}>
                ...
                <Col span={8} className=" ">
                    <div style={{ border: "2px solid #f8f3f3ff", }} >
                        <div className="d-flex align-items-center p-2  mb-1 ps-2" style={{ backgroundColor: '#eef4ff' }}>
                            <div
                                style={{
                ...
                <Col span={8} className="" >
                    <div style={{ border: "2px solid #f8f3f3ff" }}  >
                        <div className="d-flex align-items-center p-2 ps-2 mb-1" style={{ backgroundColor: '#f7f4ff' }}>
                            <div
                                style={{
                                    backgroundColor: "#ede6fa",
                                    padding: "6px 8px",
                ...
                <Col span={8} className="">
                    <div  style={{ border: "2px solid #f8f3f3ff" }}>
                        ...
                        <div className="d-flex align-items-center p-2 ps-2 mb-1" style={{ backgroundColor: '#fad1b8ff' }}>
                            <div
                                style={{
                                    backgroundColor: "#ede6fa",
                                    padding: "6px 8px",
                        ...
                        <div className="pe-2 ps-2">                        <MyInput
