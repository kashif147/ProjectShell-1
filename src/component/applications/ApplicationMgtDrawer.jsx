...
import { Drawer, Row, Col, Checkbox, Radio, Button } from 'antd'
...
function ApplicationMgtDrawer({ open, onClose, title = "Registration Request", isEdit = false, }) {
    ...
    const handleInputChange = (section, field, value) => {
        setInfData((prev) => {
            ...
            debugger
            // 🏥 Special case: auto-fill branch + region if workLocation changes
    ...
    return (
        <div>
            <Drawer width="1500px" open={open} onClose={() => {
                onClose()
                setErrors({})
                setInfData(inputValue)
                setSelected(select)
                            ...
                            <Col span={8}>
                                <MyDatePicker
                                    ...
                                    onChange={(date, dateString) => {
                                        ...
                                        handleInputChange("personalInfo", "dateOfBirth", moment(date).utc().toISOString())
                                    }}
                        ...
                        <Row gutter={18} className="bg-white p-1 ms-1 me-1" style={{ boxShadow: "0 2px 6px rgba(0,0,0,0.04)", }}>
                            ...
                            <Col span={12}>
                                <MyInput
                                    ...
                                    disabled={isDisable}
                                    onChange={(e) => handleInputChange("contactInfo", "adressLine3", e.target.value)}
                                />
                            </Col>
                            <Col span={12}>
                                <MyInput
                        ...
                        <Row gutter={18} className="bg-white p-1 ms-1 me-1">
                            ...
                            <Col span={12}>
                                <MyDatePicker
                                    ...
                                    onChange={(date, dateString) => {
                                        console.log(date, "dte")
                                        handleInputChange("graduationDate", moment(date).utc().toISOString())
                                    }}
                    ...
                    <Row className="bg-white p-1 pt-3 ms-1 me-1" gutter={18} >
                        ...
                        <Col span={12}>
                            <MyDatePicker
                                label="Retired Date"
                                name="retiredDate"
                                value={InfData.isRetired?.retiredDate ? moment(InfData.isRetired?.retiredDate, "DD/MM/YYYY") : null}
                                ...
                                onChange={(date) =>
                                    handleInputChange("professionalDetails", "retiredDate", date ? moment(date).utc().toISOString() : null)
                    ...
                    <Row gutter={18} className="bg-white p-1 ms-1 me-1" >
                        ...
                        <Col span={12}>
                            <MyInput
                                ...
                                required={InfData?.subscriptionDetails?.paymentType === 'Deduction at Source'}
                                disabled={InfData?.subscriptionDetails?.paymentType !== 'Deduction at Source'}
                    ...
                    <Row className="bg-white p-1 ms-1 me-1" gutter={18}>
                        <Col span={12}>
                            <Checkbox
                                ...
                                onChange={(e) =>
                                    handleInputChange("subscriptionDetails", "incomeProtectionScheme", e.target.checked)
                                }
                                className="my-input-wrapper"
                                disabled={
                                    !["new", "graduate"].includes(InfData?.incomeProtectionScheme?.inmoRewards) || isDisable
                                }
                            >
                        ...
                        <Col span={12}>
                            <Checkbox
                                ...
                                onChange={(e) =>
                                    handleInputChange("subscriptionDetails", "rewardsForInmoMembers", e.target.checked)
                                }
                                className="my-input-wrapper"
                                disabled={
                                    isDisable || !["new", "graduate"].includes(InfData?.subscriptionDetails?.inmoRewards)
                                }
                            >
                        ...
                        <Col span={12}>
                            <Checkbox
                                ...
                                onChange={(e) =>
                                    handleInputChange("subscriptionDetails", "valueAddedServices", e.target.checked)
                                }
                                className="my-input-wrapper"
                            >
                                Tick here to allow our partners to contact you about Value added Services
                                by Email and SMS
                            </Checkbox>
                        </Col>
                        ...
                        <Col span={12}>
                            <Checkbox
                                ...
                                onChange={(e) =>
                                    handleInputChange("subscriptionDetails", "termsAndConditions", e.target.checked)
                                }
                                className="my-input-wrapper"
                            >
